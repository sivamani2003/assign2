...
const Admin = () => {
  ...
  if (!token) {
    return <div className="min-h-screen flex items-center justify-center bg-gray-50 text-gray-600 text-lg">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-blue-100 flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-3xl bg-white shadow-xl rounded-lg p-6 mb-8">
        <h2 className="text-2xl font-bold text-blue-700 text-center mb-6">Account Details</h2>
        <div className="text-gray-700">
          <div className="flex items-center justify-between mb-4">
            <span className="font-semibold">Name:</span>
            <span>{tokenPayload.name || 'Not Available'}</span>
          </div>
          <div className="flex items-center justify-between mb-4">
            <span className="font-semibold">DOB:</span>
            <span>{tokenPayload.dob ? formatDOB(tokenPayload.dob) : 'Not Available'}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="font-semibold">Email:</span>
            <span>{tokenPayload.email || 'Not Available'}</span>
          </div>
        </div>
      </div>
